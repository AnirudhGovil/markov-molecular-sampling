'''
Module for the Graph Convolutional Network (GCN) model.
'''
...
class GraphEncoder(nn.Module):
    '''
    Class for the encoder of the Graph Convolutional Network (GCN) model.
    '''
    def __init__(self,
...
class MPNN(nn.Module):
    '''
    Class for the message passing layer.
    '''
...
class MLP(nn.Module):
    '''
    Class for the Multi-Layer Perceptron (MLP) layer.
    '''
